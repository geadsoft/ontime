            ...
            <div class="card" id="orderList">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">Listado de Cargos - Departamento</h5>
                            ...
                            <div class="col-xxl-5 col-sm-6">
                                <div class="search-box">
                                    <input type="text" class="form-control search"
                                        placeholder="Buscar por descripcion..." wire:model="filters.descripcion">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header bg-light p-3">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        @if($showEditModal)
                                            <span>Editar Cargo - Departamento  &nbsp;</span>
                                        @else
                                            <span>Agregar Cargo - Departamento  &nbsp;</span>
                                        @endif
                                    </h5>
